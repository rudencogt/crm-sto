...
from app.models.order import Order, OrderHistory, OrderActionType  # Импортируем нужные модели
...
def create_full_order(
    ...
    db.add(vehicle)
    db.flush()  # Сгенерировать ID для автомобиля
